...
export const mockMitigations: Mitigation[] = [
  {
    ...
    action_type: "police",
    action_params: { rate_bps: 5000000 },
    status: "active",
    created_at: ago(2),
    updated_at: ago(2),
  ...
  },
  {
    ...
    action_type: "police",
    action_params: { rate_bps: 10000000 },
    status: "escalated",
    created_at: ago(15),
    updated_at: ago(8),
    ...
    last_event_id: "evt-003b",
    escalated_from_id: null,
    reason: "NTP amplification attack",
    rejection_reason: null,
  },
  {
    ...
    action_type: "police",
    action_params: { rate_bps: 2000000 },
    status: "active",
    created_at: ago(8),
    updated_at: ago(8),
    ...
    escalated_from_id: null,
    reason: "DNS amplification detected",
    rejection_reason: null,
  },
  {
    ...
    action_type: "police",
    action_params: { rate_bps: 50000000 },
    status: "active",
    created_at: ago(3),
    updated_at: ago(3),
  ...
  },
  {
    ...
    escalated_from_id: null,
    reason: "SSDP amplification detected",
    rejection_reason: null,
  },
]
